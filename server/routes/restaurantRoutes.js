...
const { addRestaurant, getRestaurants, getRestaurantsByCuisine, updateRestaurant, deleteRestaurant } = require("../controllers/restaurantController");

const restaurantRoutes = express.Router();

restaurantRoutes.post("/add-restaurant", authVendor, upload.single("restaurantImage"), addRestaurant);
restaurantRoutes.get("/restaurants", authUserOrVendor, filterRestaurants, getRestaurants);
...
restaurantRoutes.delete('/delete-restaurant/:restaurantId', authVendor, deleteRestaurant)
