            ...
            <ModalContainer>
              <DetailsContainer>
                <Form onSubmit={(e) => handleSubmit(e, close)}>
                  <h3>User Signup</h3>
                  <input type="text" name="username" onChange={handleInput} placeholder="USERNAME" required />
                  ...
                  <input type="password" name="confirmPassword" onChange={handleInput} placeholder="CONFIRM PASSWORD" required />
